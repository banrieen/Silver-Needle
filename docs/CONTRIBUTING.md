...
- Fork the repository on [Github](https://github.com/apulis//MachineDevil )
...
* Clone the remote repository
    ...
    ```shell
    # For GitHub
    git clone https://github.com/{insert_your_forked_repo}//MachineDevil .git
    git remote add upstream https://github.com/diamond-ai//MachineDevil .git
    # For Gitee
    git clone https://gitee.com/{insert_your_forked_repo}//MachineDevil .git
    git remote add upstream https://gitee.com/diamond//MachineDevil .git
    ```
...
* Raise your idea as an *issue* on [GitHub](https://github.com/apulis//MachineDevil /issues)
